<%-- 
    Document   : softscrollable
    Created on : Dec 22, 2016, 10:48:44 AM
    Author     : u27brvz04
--%>
...
//          getting data
        ...
        <div class="dictionary-content">
            ...
            <div id="scrollable-container" style="display: block;overflow-y: auto;overflow-x: hidden;">
                <table class="singleline">    
                    <tbody>
                        <tr>
                            <td style="width:80px;border-top:none;"></td>
                            <td style="width:500px;border-top:none;"></td>
                            <td style="width:150px;border-top:none;"></td>
                            <td style="width:80px;border-top:none;"></td>
                        </tr>
                        <%while (pageRows.next()) {%>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $(window).resize(function () {
                    var $table = $("table.singleline"),
                            $bodyCells = $table.find("tbody tr:first").children("td:not(.hidden)"),
                            $headerCells = $table.find("thead tr").children();
                    var colWidth = [80, $("#scrollable-container").width() - 310, 140, 100];
                    $bodyCells.map(function (i) {
                        $(this).css("width", colWidth[i] + "px");
                    });
                    $headerCells.map(function (i) {
                        $(this).css("width", colWidth[i] + "px");
                    });
                    if ($("#scrollable-container").hasScrollBar() && $table.find("thead tr").children("#scroll-emitator").length === 0) {
                        $("table.singleline thead tr td").last().css("border-right", "none");
                        $("table.singleline thead tr").append($("<td>").prop("id", "scroll-emitator"));
                    } else if (!$("#scrollable-container").hasScrollBar() && $table.find("thead tr").children("#scroll-emitator").length !== 0) {
                        $("table.singleline thead tr td#scroll-emitator").remove();
                    }
                    $("#scrollable-container").css("height", $(this).height() - $("#scrollable-container").offset().top
                            - parseInt($(".dictionary-content").css("padding-bottom")) + "px");
                }).resize();
            });
            (function ($) {
